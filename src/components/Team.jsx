...
const Team = () => {
  return (
    <section className=" sm:py-20 py-10 sm:mb-28 mb-0">
        ...
        <div className="sm:bg-blue-300 bg-white sm:h-[300px] h-full   p-3 relative">
          ...
          <div className="grid sm:grid-cols-3 gap-5 left-0 right-0  static sm:absolute top-0  sm:top-[170px]">
            <div className="flex flex-col items-center space-y-1 justify-center">
              ...
              <h2 className="text-lg font-bold">Deng Woi Akec</h2>
              <p>Director Communication and blogger</p>
            </div>
            <div className="flex flex-col items-center space-y-1 justify-center">
              <div className=" h-[300px]  w-[300px] flex">
                <img
              ...
              <h2 className="text-lg font-bold">Madieu Kuot Ayii</h2>
              <p>Director Programs and Technical lead</p>
            </div>{" "}
            <div className="flex flex-col items-center space-y-1 justify-center">
              <div className=" h-[300px]  w-[300px] flex">
                <img
              ...
              <h2 className="text-lg font-bold">Deng Mayen Ayuel</h2>
